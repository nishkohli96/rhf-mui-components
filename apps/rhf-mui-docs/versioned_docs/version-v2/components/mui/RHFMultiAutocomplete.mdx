...
- [Autocomplete with Checkboxes](https://v6.mui.com/material-ui/react-autocomplete/#checkboxes)
- [Complete Form](https://rhf-mui-components-examples.netlify.app/complete-form)

## API
The `RHFMultiAutocompleteProps` interface extends [AutocompleteProps](https://v6.mui.com/material-ui/api/autocomplete/)
