...
title: Customization
description: Configure ConfigProvider once to apply global default styles for FormLabel, FormHelperText and FormControlLabel, set a shared dateAdapter, and enable allLabelsAboveFields — no per-component overrides needed.
---
