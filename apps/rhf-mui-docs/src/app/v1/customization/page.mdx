...
All components share at least two common props: [FormLabel](https://v5.mui.com/material-ui/api/form-label/) 
and [FormHelperText](https://v5.mui.com/material-ui/api/form-helper-text/).
Components like checkbox or switch also include a [FormControlLabel](https://v5.mui.com/material-ui/api/form-control-label/). 
...
date and time pickers, with `AdapterDayjs` being [recommended by Material UI](https://v6.mui.com/x/react-date-pickers/base-concepts/#recommended-library).
...
[FormLabel](https://v5.mui.com/material-ui/api/form-label/),
[FormControlLabel](https://v5.mui.com/material-ui/api/form-control-label/),
and [FormHelperText](https://v5.mui.com/material-ui/api/form-helper-text/) components.
...
which accepts all valid values in the [`sx` prop](https://v5.mui.com/material-ui/customization/how-to-customize/#the-sx-prop).
...
[MUI date library options](https://v6.mui.com/x/react-date-pickers/base-concepts/#date-library).
