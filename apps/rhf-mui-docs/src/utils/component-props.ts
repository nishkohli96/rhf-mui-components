 ...
 * `muiVersion`/`muiXVersion` (passed in from `props-table/index.ts`)
...
export const getMuiPickersDocsUrl = (muiXVersion?: PropsDescriptionArgs['muiXVersion']) =>
  `https://${muiXVersion ? `v${muiXVersion}.` : ''}mui.com/x/api/date-pickers`;
