...
<Callout type="info" title="Rewritten in v4">
...
If you're upgrading from **v3**, please refer to the [migration guide](/migration-guide) for breaking changes and migration steps.
</Callout>
...
## Examples
- [RHFFileUploader](https://rhf-mui-components-examples.vercel.app/inputs)
...
<PropsTable rows={componentPropsV4.RHFFileUploader} />
